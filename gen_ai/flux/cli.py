...
from .trt.trt_manager import TRTManager
from .util import configs, load_ae, load_clip, load_flow_model, load_t5, save_image
...
def load_models(
    ...
    **kwargs: dict | None,
    ...
    while opts is not None:
        ...
        return model, inp, timesteps, opts, ae
